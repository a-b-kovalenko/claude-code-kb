...
| :--- | :--- | :--- |
| **Формат** | Flat-file, старий спосіб | Директорія з `SKILL.md`, новий спосіб |
| **Виклик** | Тільки `/команда` | `/команда` або авто-завантаження за темою |
| **Найкраще для** | Простий шаблон промпту | Глибока експертиза + процедури + slash-команда |
| **Пріоритет** | Нижчий | Вищий (перекриває команду з тим самим іменем) |
