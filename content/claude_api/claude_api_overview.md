...
Anthropic надає HTTP API для виклику Claude моделей з будь-якої мови програмування. Центральний ендпоінт — `/v1/messages`. Офіційні SDK: Python і TypeScript/JavaScript.
